...
public class SnakeView extends TileView {
     ...
     * mMoveDelay: number of milliseconds between snake movements. This will decrease as apples are captured.
     */
     ...
     */
    public void setDependentViews(TextView msgView, View arrowView) {
        mStatusText = msgView;
    ...
    private void addRandomApple() {
        ...
        while (!found) {
            ...
            for (int index = 0; index < snakelength; index++) {
                if (mSnakeTrail.get(index).compare(newCoord)) {
                    collision = true;
                }
            }
    ...
    /**
     * Todo: a simple Coordinate class containing two integer values (x, y) and a comparison method.
     */
